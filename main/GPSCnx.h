...
class GPSCnx {
  public:
    ...
    virtual uint32_t waitForChars(int first_timeout_ms = 1000, int next_timeout_ms = 20, bool inject = true) = 0;
...
class GPSUARTCnx: public GPSCnx {
  public:
    ...
    virtual uint32_t waitForChars(int first_timeout_ms = 1000, int next_timeout_ms = 5, bool inject = true);
  protected:
